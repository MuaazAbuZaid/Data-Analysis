...
def margin_bar(df):
    ...
    fig_margin.add_vline(x= df_margin.margin.mean(), opacity=1, line_width=2, line_dash='dash', line_color='Red', annotation_text= f'Mean of Profit margin \n {int(df_margin.margin.mean())} %', annotation_font_color = "Red")
    return fig_margin
